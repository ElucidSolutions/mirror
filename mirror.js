    ...
    function (next) {
      setTimeout (
        function () {
          ...
          var cmd = 'rsync ' + (connection.delete ? '--delete ' : '') + '--recursive --filter="' + connection.filter + '" "' + connection.local_path + '" "' + connection.remote_user + '@' + connection.remote_host + ':' + connection.remote_path + '"';
          console.log ('cmd: "' + cmd + '"');
